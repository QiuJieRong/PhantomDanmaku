...
namespace PhantomDanmaku
{
    public class MapGenerator : SingletonMono<MapGenerator>
    {
        ...
        void Start()
        {
            // GameEntry.UI.OpenUIForm("Assets/PhantomDanmaku/UI/")
            GeneratorMap();
            GameSystem.Instance.AddEventListener<Room>(CustomEvent.RoomEnter, RoomEnterCallback);
            GameSystem.Instance.AddEventListener<Room>(CustomEvent.RoomClear, RoomClearCallback);
        }
