            ...
            switch (type)
            {
                case E_Door_Type.Horizontal:
                    for (int i = 1; i <= width / 2; i++)
                    {
                        ...
                        tilemap_object.SetTile((Vector3Int)centerCoord + new Vector3Int(-i, 0, 0), door);
                        tilemap_object.SetColliderType((Vector3Int)centerCoord + new Vector3Int(i, 0, 0),
                ...
                case E_Door_Type.Vertical:
                    for (int i = 1; i <= width / 2; i++)
                    {
                        ...
                        tilemap_object.SetTile((Vector3Int)centerCoord + new Vector3Int(0, -i, 0), door);
                        tilemap_object.SetColliderType((Vector3Int)centerCoord + new Vector3Int(0, i, 0),
                            Tile.ColliderType.None);
                        tilemap_object.SetColliderType((Vector3Int)centerCoord + new Vector3Int(0, -i, 0),
                            Tile.ColliderType.None);
            ...
            switch (type)
            {
                case E_Door_Type.Horizontal:
                    for (int i = 1; i <= width / 2; i++)
                    {
                        tilemap_object.SetColliderType((Vector3Int)centerCoord + new Vector3Int(i, 0, 0),
                            Tile.ColliderType.None);
                        SetSortingOrder(tilemap_object, (Vector3Int)centerCoord + new Vector3Int(i, 0, 0),
                            tileObjLayer);
                        tileObj = tilemap_object.GetInstantiatedObject(
                            (Vector3Int)centerCoord + new Vector3Int(i, 0, 0));
                        tileObj.GetComponentInChildren<Animator>().SetBool("IsOpen", true);
                        ...
                        SetSortingOrder(tilemap_object, (Vector3Int)centerCoord + new Vector3Int(-i, 0, 0),
                            tileObjLayer);
                        tileObj = tilemap_object.GetInstantiatedObject((Vector3Int)centerCoord +
                ...
                case E_Door_Type.Vertical:
                    for (int i = 1; i <= width / 2; i++)
                    {
                        tilemap_object.SetColliderType((Vector3Int)centerCoord + new Vector3Int(0, i, 0),
                            Tile.ColliderType.None);
                        SetSortingOrder(tilemap_object, (Vector3Int)centerCoord + new Vector3Int(0, i, 0),
                            tileObjLayer);
                        tileObj = tilemap_object.GetInstantiatedObject(
                            (Vector3Int)centerCoord + new Vector3Int(0, i, 0));
                        tileObj.GetComponentInChildren<Animator>().SetBool("IsOpen", true);
